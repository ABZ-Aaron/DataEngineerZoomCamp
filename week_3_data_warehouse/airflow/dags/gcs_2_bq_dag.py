...
with DAG(
    ...
    CREATE_PART_TBL_QUERY = f"CREATE OR REPLACE TABLE silent-oasis-338916.trips_data_all.external_yellow_tripdata_partitoned_week3 \
                                PARTITION BY \
                                DATE(tpep_pickup_datetime) AS \
                                SELECT * FROM {BIGQUERY_DATASET}.external_yellow_tripdata_week3;"
